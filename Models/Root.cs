...
namespace WeatherTracker.Models
{
    ...
    public class Condition
    {
        ...
        public string customIcon => string.Format("https:{0}",icon);
    ...
    public class Forecastday
    {
        ...
        public string GetDayOfWeek(int epochTimestamp)
        {
            DateTime dateTime = DateTimeOffset.FromUnixTimeSeconds(epochTimestamp).UtcDateTime;
            string dayOfWeekAbbreviation = dateTime.ToString("ddd").ToUpper();
            return dayOfWeekAbbreviation;
        }
        public string dayName => GetDayOfWeek(date_epoch);
